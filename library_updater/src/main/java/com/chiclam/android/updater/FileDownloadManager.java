...
public class FileDownloadManager {
    ...
    public String getDownloadPath(Context context){
        return context.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath() + File.separator + "com_jkll_app_update.apk";
    }
    ...
    long startDownload(UpdaterConfig updaterConfig) {
        ...
        req.setDestinationInExternalFilesDir(updaterConfig.getContext(), Environment.DIRECTORY_DOWNLOADS, "com_jkll_app_update.apk");
