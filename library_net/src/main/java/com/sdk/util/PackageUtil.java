...
public class PackageUtil {
     ...
     * 普通安装
     */
    public static void installApkNormal(Context context, String title, String filePath) {
        try {
     ...
     * @return
     */
    public static boolean isInstalledApk(Context context, String packageName, int versionCode) {
        try {
            if (TextUtils.isEmpty(packageName)) {
                return false;
            }
     ...
     * 启动应用的某个页面
     */
    public static boolean startAppActivity(Context context, String packageName, String className) {
    ...
    public static boolean isRunningInFront(Context sContext, String packageName) {
    ...
    public static boolean isRunning(Context sContext, String packageName) {
        Context context = sContext.getApplicationContext();
        ActivityManager am = (ActivityManager) context.getSystemService(Context.ACTIVITY_SERVICE);
        List<ActivityManager.RunningAppProcessInfo> infos = am.getRunningAppProcesses();
    ...
    public static String getTopActivity(Context sContext, int type) {
        Context context = sContext.getApplicationContext();
    ...
    public static String getTopRunningApp(Context context) {
        String result = "";
        result = getTopActivity(context, 1);
        return result;
    }
