 ...
 */
public class Log {
	private static boolean DEBUG = Const.DEBUG;
        ...
        synchronized(lock) {
            try {
        		...
        		if (Util.isSDCardAvailable()) {
        			logDirPath = App.getInstance().getLogCacheDir();
                } else {
                	logDirPath = context.getFilesDir().getAbsolutePath() + File.separator + Const.DIR_LOG;
                }
