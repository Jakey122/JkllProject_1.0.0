 ...
 */
public class PayFailDialog extends BaseActivity implements View.OnClickListener {
    ...
    public static void showDialog(Context context, int type, BaseInfo info) {
        try {
            Intent intent = new Intent(context, PayFailDialog.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_dialog_pay_fail);
        initData();
        initView();
    }
    ...
    private void initView() {
        ...
        message.setText(getResources().getString(R.string.error_pay_msg));
    ...
    public void addStatistics(Context mContext) {
        AppLogUtil.addOpenViewLog(mContext, PageId.PageOrder.PAGE_ORDER_DETAIL_PAY_FAIL, mType, "-1", "-1");
    }
}
