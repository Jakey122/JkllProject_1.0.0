...
package com.android.apps.animation;
...
//                    Log.e("dyr11", " scale = " + tagetScale);
    ...
    public static void showTopOutAnimator(final View view, final long duration, final IAnimationHelper helper) {
        showAnyWhereOutAnimator(view, duration, helper, true);
    }

    public static void showAnyWhereOutAnimator(final View view, final long duration, final IAnimationHelper helper, final boolean fromTop) {
        if (view == null) return;
        postAnimation(new Runnable() {
            @Override
            public void run() {
                ...
                float[] y = new float[]{0f, fromTop ? -height : height};
...
//                        -view.getHeight());
    ...
    public static void showTopInAnimator(final View view, final long duration, final IAnimationHelper helper) {
        showAnyWhereInAnimator(view, duration, helper, true);
    }

    public static void showAnyWhereInAnimator(final View view, final long duration, final IAnimationHelper helper, final boolean fromTop) {
        if (view == null) return;
        postAnimation(new Runnable() {
            @Override
            public void run() {
                view.setVisibility(View.VISIBLE);
                int height = view.getHeight();
                float[] y = new float[]{fromTop ? -height : height, 0f};
                ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(view, "translationY", y);
...
//                        -view.getHeight(), 0f);
    ...
    public static void showTada(final View view, final float shakeFactor, final IAnimationHelper helper) {
        showTada(view, shakeFactor, 1000, helper);
    }

    public static void showTada(final View view, final float shakeFactor, final long duration, final IAnimationHelper helper) {
        if (view == null) return;
        postAnimation(new Runnable() {
            @Override
            public void run() {
    ...
    public static void showCircularReveal(final View view, final int width, final int height, final long duration, final long delay, final IAnimationHelper helper) {
        if (view == null) return;
        view.clearAnimation();
        view.setVisibility(View.INVISIBLE);
                    ...
                    public void run() {
                        ...
                        animator.addListener(new AnimatorListenerAdapter() {
                            ...
                            public void onAnimationEnd(Animator animation) {
                                ...
                                view.setVisibility(View.VISIBLE);
                                if (helper != null) helper.onAnimatorEnd(animation);
                            }
